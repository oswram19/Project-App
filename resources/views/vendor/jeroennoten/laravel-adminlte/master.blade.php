...
<head>
    ...
    {{-- Prevención de parpadeo en modo oscuro: se aplica ANTES de cualquier paint --}}
    <script>
        (function () {
            try {
    ...
    {{-- Estilos inline anti-FOUC: aplican el fondo oscuro SIN esperar archivos CSS externos --}}
    <style>
        html.dark {
            background: linear-gradient(135deg, #111827 0%, #1f2937 55%, #1e3a8a 100%) !important;
        }
        html.dark body {
            background: linear-gradient(135deg, #111827 0%, #1f2937 55%, #1e3a8a 100%) !important;
